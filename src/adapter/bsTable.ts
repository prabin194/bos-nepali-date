// Generated from /Users/prabinpaudel/Downloads/BS.php
// Each entry: [Baisakh, Jestha, Ashadh, Shrawan, Bhadra, Ashwin, Kartik, Mangsir, Poush, Magh, Falgun, Chaitra]

export const bsMonthData: Record<number, [number, number, number, number, number, number, number, number, number, number, number, number]> = {
